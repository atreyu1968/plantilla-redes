...
export function CenterForm({ onClose, onSuccess, initialData, isEdit }: CenterFormProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (isEdit && initialData?.id) {
        await axios.put(
          `${SERVER_CONFIG.BASE_URL}/api/centers/${initialData.id}`,
          formData,
          config
        );
      } else {
        await axios.post(`${SERVER_CONFIG.BASE_URL}/api/centers`, formData, config);
      }
